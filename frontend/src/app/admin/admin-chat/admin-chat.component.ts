...
import { AdminChatbotService, AdminChatMessage } from '../../core/services/admin-chatbot.service';
...
@Component({
    ...
    standalone: true,
    imports: [BreadcrumbComponent, NgIf, NgFor, NgClass, ButtonDirective, FormsModule, InputTextModule]
})
export class AdminChatComponent implements OnInit, AfterViewChecked {
  ...
  constructor(@Inject(AdminChatbotService) private adminChatbotService: AdminChatbotService) {}
