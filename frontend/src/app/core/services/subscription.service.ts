...
export interface CreateSubscriptionRequest {
  userId: string;  // Note: clientId remplacé par userId pour correspondre au backend
  produitId: string;
  packId?: string;
...
export class SubscriptionService {
  private readonly baseUrl = environment.apiSouscription;
  private readonly creationUrl = environment.apiSouscription.replace('/contrats', '/souscription/creer');
