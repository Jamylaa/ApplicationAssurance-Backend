...
public class UserValidator {
    ...
    private static final int MIN_PASSWORD_LENGTH = 6;
     ...
     //@param username Le username à valider + @return message d'erreur si invalide, null si valide
    public static String validateUsername(String username) {
        ...
        if (trimmedUsername.length() > 30) {
            return "Le username ne peut pas dépasser 20 caractères";}
     ...
     //@param password Le mot de passe à valider + @return message d'erreur si invalide, null si valide
    public static String validatePassword(String password) {
     ...
     // @param email L'email à valider + @return message d'erreur si invalide, null si valide
    ...
    // Valide le numéro de téléphone
     // @param phone Le numéro de téléphone à valider + @return message d'erreur si invalide, null si valide
    public static String validatePhone(Integer phone) {
        if (phone == null) {return "Le numéro de téléphone ne peut pas être vide";}
        String phoneStr = phone.toString();
        // Vérifier que c'est un nombre positif
        if (phone < 0) {return "Le numéro de téléphone doit être positif";}
        // Vérifier la longueur (Tunisie: 8 chiffres)
        if (phoneStr.length() != 8) {return "Le numéro de téléphone doit contenir 8 chiffres";}
        // Vérifier qu'il commence par les bons préfixes tunisiens
        if (!phoneStr.matches("^[2-9]\\d{7}$")) {return "Le numéro de téléphone doit commencer par 2, 4 , 5 ou 9";}
        return null; // Valide
    }
}